...
/* GOLD ANSWER
for(let i = 0; i < presidents.length; i++){
    !presidents[i].passed ? console.log(presidents[i].last, presidents[i].first) : null
}
*/

//PLATINUM: create a new variable called filteredPresidents and use a .filter to loop through the array

//PLATINUM ANSWER
for(let i = 0; i < filteredPresidents.length; i++){
    console.log(filteredPresidents[i].first, filteredPresidents[i].last)
}